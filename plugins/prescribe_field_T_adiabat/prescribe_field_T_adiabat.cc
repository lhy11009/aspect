...
namespace aspect
{
  ...
  // todo_adiabat
  double mantle_adiabat_T(const double depth)
  {
    ...
    const double temperature =  potential_mantle_temperature *
  ...
  {
    //todo_adiabat
    prm.declare_entry ("Prescribe internal mantle adiabat temperatures", "false",
                       Patterns::Bool (),
    ...
    prm.enter_subsection ("Prescribed mantle adiabat temperatures");
    {
  ...
  void parse_parameters(const Parameters<dim> &,
                        ParameterHandler &prm)
  {
    prescribe_internal_temperatures = prm.get_bool ("Prescribe internal mantle adiabat temperatures");
  ...
  */
   ...
   */
  template <int dim>
  void constrain_internal_mantle_adiabat_temperatures (const SimulatorAccess<dim> &simulator_access,
  ...
  {
    signals.post_constraints_creation.connect (&constrain_internal_mantle_adiabat_temperatures<dim>);
  }
