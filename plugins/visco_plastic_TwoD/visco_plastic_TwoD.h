...
#ifndef _aspect_material_model_visco_plastic_twod_h
#define _aspect_material_model_visco_plastic_twod_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class PlasticTwoDAdditionalOutputs : public NamedAdditionalMaterialOutputs<dim>
    {
      public:
        PlasticTwoDAdditionalOutputs(const unsigned int n_points);
     ...
     */
    template <int dim>
    class TwoDAdditionalViscosityOutputs : public NamedAdditionalMaterialOutputs<dim>
    {
      public:
        TwoDAdditionalViscosityOutputs(const unsigned int n_points);
    ...
    */
    ...
    class ViscoPlasticTwoD : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      ...
      private:
        ...
        * particle property.
        * Overload the function defined in the material interface.
        */
        double computeEqP(const double T) const override;
         ...
         */
        std::unique_ptr<Rheology::PeierlsCreep1<dim>> peierls_creep;
        ...
        */
        ...
        /**
         * Whether using a mixing model for multi-phase rheology
         * Include options for the mixing models to use for each composition
         * 1: iso stress (weakest), 2: iso strain (strongest), 3: log (intermediate)
        */
        bool use_phase_rheology_mixing;
        std::vector<int> phase_rheology_mixing_models;

        /**
        * Divide the volume fraction of eclogite by this number
        ...
        */
        ...
        bool reaction_metastable_trivial;

        /**
         * Water contents in kinetics
         */
        double coh_for_Kinetics;

        /**
         * Object for metastable kinetics.
         */
        std::unique_ptr<MaterialUtilities::MO_KINETICS<dim>> Mo_Kinetics;
