...
#ifndef _aspect_material_model_visco_plastic_subduction_h
#define _aspect_material_model_visco_plastic_subduction_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class ViscoPlasticSubduction : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
      ...
      private:
        ...
        /**
         * Whether to use the entropy method
        */
        bool use_entropy_method;
        ...
        * EOS equation and the rheologic formula.
        */
        bool use_adiabatic_pressure_in_eos;
        bool use_adiabatic_pressure_in_rheology;
    };
