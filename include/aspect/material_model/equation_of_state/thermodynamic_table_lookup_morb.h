...
#ifndef _aspect_material_model_equation_of_state_thermodynamic_table_lookup_morb_h
#define _aspect_material_model_equation_of_state_thermodynamic_table_lookup_morb_h
...
namespace aspect
{
  namespace MaterialModel
  {
    namespace EquationOfState
    {
       ...
       */
      template <int dim>
      class ThermodynamicTableLookupMorb : public ::aspect::SimulatorAccess<dim>
      {
        public:
          /**
          ...
          fill_additional_outputs(const MaterialModel::MaterialModelInputs<dim> &in,
                                  ...
                                  unsigned morb_composition_index=0) const;
