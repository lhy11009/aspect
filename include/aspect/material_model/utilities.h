      ...
      class PhaseFunction: public ::aspect::SimulatorAccess<dim>
      {
        public:
          ...
          */
          ...
          /**
           * Determine if the current phase transition is beyond the decomposition reaction, 670 km
          */
          bool is_beyond_decomposition (const unsigned int phase_transition_index) const;


          /**
           * Determine if the current phase is a metastable phase (between the metastable and decomposition
           * transition)
          */
          bool is_metastable_phase (const unsigned int phase_index) const;
        ...
        private:
          ...
          */
          ...
          /**
           * Whether to use metastable kinetics and mark phases of decomposition
           */
          std::vector<bool> use_metastable_decompositions;
...
// Solve the Modified Equation (18)
      ...
      template <int dim>
      class MO_KINETICS: public ::aspect::SimulatorAccess<dim>
      {
        public:
