...
#ifndef _aspect_material_model_rheology_peierls_creep_1_h
#define _aspect_material_model_rheology_peierls_creep_1_h
...
namespace aspect
{
  namespace MaterialModel
  {
    ...
    namespace Rheology
    {
       ...
       */
      struct PeierlsCreep1Parameters
      {
        /**
       ...
       */
      template <int dim>
      class PeierlsCreep1 : public ::aspect::SimulatorAccess<dim>
      {
        public:
          /**
           * Constructor.
