  ...
  namespace InitialComposition
  {
      ...
      if (compositional_index == metastable_index)
        {
          ...
          // we make this variable 0.0 if equilirbrium phase transition happens
          ...
          double metastable = (depth_deviation > -1.0 * transition_width)? 0.0: 1.0;
    ...
    Metastable<dim>::declare_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Initial composition model");
      {
        ...
        {
          prm.declare_entry ("Phase transition depth", "520e3", Patterns::Double (),
                             "Depth of the metastable phase transition");

          prm.declare_entry ("Phase transition width", "0.0", Patterns::Double (),
          ...
          prm.declare_entry ("Phase transition temperature", "1662.0", Patterns::Double (),
                             "Temperature of the metastable phase transition");

          prm.declare_entry ("Phase transition Clapeyron slope", "4.1e6", Patterns::Double (),
